...
$mail=$_POST['emailtxt'];
$sql_ins=mysql_query("INSERT INTO teacher_tbl VALUES( NULL,'$f_name','$l_name' ,'$gender','$dob','$addr','$degree','$salary' ,'$married','$phone','$mail','staff')");
if($sql_ins==true) {
$msg = ucfirst($f_name) ;
echo "<div>"
...
. "</button>"
. "<strong>Sucess!</strong> Staff $msg record inserted"
. "</div>"
. "</div>";
}
else
...
if($opr=="upd")
{
$sql_upd=mysql_query("SELECT * FROM teacher_tbl WHERE teacher_id=$id and type='staff'");
$rs_upd=mysql_fetch_array($sql_upd);
list($y,$m,$d)=explode('-',$rs_upd['dob']);
?>
<div class="col-md-10 col-md-offset-1 form-style">
<div class="col-md-12 entry-head margin-20b">
<h4 class="left">Staff Update</h4>
<a class="btn btn-primary right" href="?tag=view_staff">Back</a>
</div>
<div class="col-md-10 col-md-offset-1 form-style">
...
<option <?php if($rs_upd['degree']=="Basic") echo "selected";?>>Basic</option>
<option <?php if($rs_upd['degree']=="Matric") echo "selected";?>>Matric</option>
<option <?php if($rs_upd['degree']=="F.S.C") echo "selected";?>>F.S.C</option>
</select>
</div>
</div>
<div class="form-group">
...
<div class="col-md-10 col-md-offset-1 form-style">
<div class="col-md-12 entry-head margin-20b">
<h4 class="left">Staff Entry</h4>
<a class="btn btn-primary right" href="?tag=view_staff">Staff View</a>
</div>
...
<label for="slarytxt" class="control-label col-sm-3">Salary:</label>
<div class="col-sm-8">
<input type="number" class="form-control only-number" id="slarytxt" name="slarytxt" placeholder="staff Salary..." required>
</div>
</div>
<div class="form-group">
<label for="degree" class="control-label col-sm-3">Degree:</label>
...
<!-- <form method="post">-->
<!-- <a href="?tag=view_staff"><input type="button" name="btn_view" title="View staff" value="View staff" id="button_view" style="width:120px;" /></a>-->
<!---->
<!-- </form>-->
