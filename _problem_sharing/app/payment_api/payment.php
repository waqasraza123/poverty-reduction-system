...
class PaymentApi{
    ...
    protected $amount_entered, $custom_message;

    public function __construct()
    {
        if(isset($_POST["amount"]) && !empty($_POST["amount"])) {
            $amount_entered = $_POST["amount"] * 100;
            $custom_message = "Amount for Problem Sharing Module";
        }
    }
}
...
<form action="charge.php" method="POST">
    <input type="hidden" name="amount" value= "<?php echo $this->amount_entered;?>">
    <input type="hidden" name="custom_mess" value= "<?php echo $this->custom_message;?>">
    ...
    <script
        ...
        data-currency = "PKR"
        data-amount="<?php echo $this->amount_entered;
        ?>"
        data-locale="auto">
    </script>
</form>
